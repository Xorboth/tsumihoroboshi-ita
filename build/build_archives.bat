...
set higurashiData=HigurashiEp06_Data
...
set output07th=tsumihoroboshi_ita_07th_mod_installer.7z
set outputWindowsSteamGogMangaGamer=tsumihoroboshi_ita_windows_steam_gog_mg_%version%.7z
set outputLinuxMacOsSteamGogMangaGamer=tsumihoroboshi_ita_linux_macos_steam_gog_mg_%version%.7z
